...
layout = html.Div([
    ...
    html.Div([
        dcc.Markdown('Number of latent factors',
                     dangerously_allow_html=True),
        dcc.Slider(id='slider-latent', min=0, max=200, step=10,
                   marks={i: '{}'.format(i) for i in range(0, 200, 10)}, value=50),
        ...
        dcc.Markdown('<br/>Bias Regularization',
                     dangerously_allow_html=True),
        dcc.Slider(id='slider-bias', min=0, max=1, step=0.05, value=0,
